...
{
    $main_id=$_GET['id'];
    $sql_update=mysqli_query($db, "update message set status=1 where id='$main_id'");
}*/
...
<html lang="en">
  ...
  ?>
    ...
    <div class="templatemo-content-widget no-padding white-bg">
          			  ...
          			  <table class="table table-striped table-bordered templatemo-user-table">
                          <thead>
                            <tr>
                              ...
                              <td><a   class="white-text templatemo-sort-by">S.no</a></td>
        ...
        <tbody>
            <?php
            $sr_no=1; $sql_get=mysqli_query($db, "select * from message where status=0");
