...
<html lang="en">
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            ...
            <h5><center>
              Pending request will be shown here
            </center></h5>
          </div>
  ...
  {
    ?>
    <?php   $_SESSION['temp_usn']=$results['username']; ?>
    ...
    <td><?php  echo $results['date_created'] ?></td>
      <td> <a href="approval.php?id=<?php echo $results['username'];?>" class="btn btn-success">Approve</a>
            <a href="Deleteuser.php?id=<?php echo $results['username'];?>" class="btn btn-danger">Decline</a> </td>
    </tr>
<?php
  }
