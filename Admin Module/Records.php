      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            <h1><center><a href="../Admin module/Student-Record.php">Student Records</a></center></h1>

          </div>
          <div class="templatemo-content-widget white-bg">
            <h1><center><a href="../Admin module/Company-Record.php">Company Records</a></center></h1>

          </div>
          <div class="templatemo-content-widget white-bg">
            <h1><center><a href="../Admin module/Placed-Student.php">Placed students records</a> </center></h1>
